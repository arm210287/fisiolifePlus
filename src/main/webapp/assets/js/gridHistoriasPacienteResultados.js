...
function datosGrid(){
	...
	$("#jqxgrid").jqxGrid(
	{
	    ...
	    columns: [
	        ...
	        { text: 'Tratamiento'		  , datafield: 'tratamiento'		, width: 100, cellsalign: 'right', cellsformat: 'c2' },
	        ...
	        { text: 'Última Actualización', datafield: 'ultimaActualizacion', width: 100, cellsalign: 'right', cellsformat: 'c2' },
	        { text: 'Observaciones'		  , datafield: 'observaciones'		, width: 100, cellsalign: 'right', cellsformat: 'c2' }
	    ]
	});
