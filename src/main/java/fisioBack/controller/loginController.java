...
//		 * 
//		 */
//		if(!userService.isUserSSOUnique(user.getId_usuario(), user.getPrimerNombre())){
//			FieldError ssoError =new FieldError("user","ssoId",messageSource.getMessage("non.unique.ssoId", new String[]{user.getPrimerNombre()}, Locale.getDefault()));
...
//
//		model.addAttribute("success", "User " + user.getPrimerNombre() + " "+ user.getPrimerApellido() + " registered successfully");
//		model.addAttribute("loggedinuser", getPrincipal());
//		//return "success";
...
//
//		model.addAttribute("success", "User " + user.getPrimerNombre() + " "+ user.getPrimerApellido() + " updated successfully");
//		model.addAttribute("loggedinuser", getPrincipal());
//		return "registrationsuccess";
//	}
